...
export function Chains() {
    ...
    return (
        <div>
            <div className='w-[75%] m-auto py-7 mobile:w-[90%] laptop:w-[90%] flex gap-5'>
                <div className="border-b w-[91%]">
                    <div className="text-base mobile:ml-2">Correntes</div>
                    { }
                </div>
            ...
            <>
                <div className='mobile:hidden slider-container w-[75%] laptop:w-[90%] m-auto'>
                    <Slider {...settings}>
                        {prod
                            .filter((prod) => prod.category == "Correntes")
                            .map((products) => {
